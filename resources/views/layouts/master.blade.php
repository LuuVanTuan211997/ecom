...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="/" class="logo">
                ...
                <span class="logo-lg"><b>Foxpay</b></span>
            </a>
    ...
    <script src="/static/plugins/toast/toastr.min.js"></script>
    <script src="/static/plugins/input-mask/jquery.inputmask.bundle.js"></script>
    ...
    <script type="text/javascript">
        ...
        $('.row-delete-modal').on('click', function (e) {
            ...
            if (title) {
                $('#row-delete-form .modal-title').html(title);
            }
            
            if (msg) {
                $('#row-delete-form .modal-body').html(msg);
            }
        });
